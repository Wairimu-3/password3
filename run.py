...
def create_credential(uname, pword, email):
    """
    Function to create the new user credentials
    """
...
def main():
    ...
    print("Password manager, choose action from the printed list")
    ...
    while True:
        ...
        if short_code == 'def':
            ...
            site = input()
            print(f"Great you are now in {site}")
